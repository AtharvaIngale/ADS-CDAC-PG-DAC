...
public class Circular_Linked_List_Main {
	...
	public static void main(String[] args) {
		Circular_Linked_List_Functions cl = new Circular_Linked_List_Functions();
		...
		do {
			...
			case 10:
				...
				break;
			case 11:
				Circular_Linked_List_Node t1 = cl.getLast().getNext();
				cl.setLast(Circular_Linked_List_Functions.reverse(t1,t1));
