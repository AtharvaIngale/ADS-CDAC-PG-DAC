...
public class Linked_List_All_Main {
	
	public static void main(String[] args) {
		Linked_List_All_Functions list = new Linked_List_All_Functions();
		Linked_List_All_Functions list2 = new Linked_List_All_Functions();
		...
		do {
			...
			case 13:list.concate(list2);
				...
				break;
			case 14:
				Linked_List_All_Functions list3 = Linked_List_All_Functions.concateToThirdList(list, list2);
				System.out.println("1. "+list);
				System.out.println("2. "+list2);
